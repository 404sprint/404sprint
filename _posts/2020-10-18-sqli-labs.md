...
tags:
    - sqli-labs
---
<!-- TOC -->autoauto- [引言](#引言)auto    - [注入基本思路](#注入基本思路)auto    - [常用表](#常用表)auto    - [常用函数](#常用函数)auto- [less 1(get基于报错的单引号注入)](#less-1get基于报错的单引号注入)auto    - [原理](#原理)auto- [less 2(get基于报错的数字型注入)](#less-2get基于报错的数字型注入)auto    - [原理](#原理-1)auto    - [步骤](#步骤)auto- [less 3(get基于报错的单引号变形字符注入)](#less-3get基于报错的单引号变形字符注入)auto    - [原理](#原理-2)auto    - [步骤](#步骤-1)auto- [less 4(get基于报错的双引号字符型注入)](#less-4get基于报错的双引号字符型注入)auto    - [原理](#原理-3)auto    - [步骤](#步骤-2)auto- [less 5(get单引号字符型二次注入)](#less-5get单引号字符型二次注入)auto    - [原理](#原理-4)auto    - [double injection(SQL二次查询注入)](#double-injectionsql二次查询注入)auto        - [rand()](#rand)auto        - [floor()](#floor)auto        - [count()](#count)auto        - [group by](#group-by)auto        - [总结](#总结)auto    - [步骤](#步骤-3)auto- [less 6(双查询注入双引号闭合字符型)](#less-6双查询注入双引号闭合字符型)auto    - [原理](#原理-5)auto    - [步骤](#步骤-4)auto- [less7(outfile文件写入字符型)](#less7outfile文件写入字符型)auto    - [原理](#原理-6)auto    - [步骤](#步骤-5)auto- [less 8(单引号get布尔盲注)](#less-8单引号get布尔盲注)auto    - [原理](#原理-7)auto    - [步骤](#步骤-6)auto- [less 9(get时间布尔盲注)](#less-9get时间布尔盲注)auto    - [原理](#原理-8)auto    - [步骤](#步骤-7)auto- [less 10(双引号get时间布尔盲注)](#less-10双引号get时间布尔盲注)auto    - [原理](#原理-9)auto    - [步骤省略](#步骤省略)auto- [less 11(post基于错误的单引号字符串注入)](#less-11post基于错误的单引号字符串注入)auto    - [原理](#原理-10)auto    - [步骤](#步骤-8)auto- [less 12(基于错误的双引号POST型字符变形的注入)](#less-12基于错误的双引号post型字符变形的注入)auto    - [原理](#原理-11)auto    - [步骤](#步骤-9)auto- [less 13(POST单引号变形双注入)](#less-13post单引号变形双注入)auto    - [原理](#原理-12)auto    - [步骤](#步骤-10)auto- [less 14(POST单引号变形双注入)](#less-14post单引号变形双注入)auto    - [原理](#原理-13)auto    - [步骤](#步骤-11)auto- [less 15(基于bool型/时间延迟单引号POST型盲注)](#less-15基于bool型时间延迟单引号post型盲注)auto    - [原理](#原理-14)auto    - [步骤](#步骤-12)auto- [less 16(基于bool型/时间延迟的双引号POST型盲注)](#less-16基于bool型时间延迟的双引号post型盲注)auto    - [原理](#原理-15)auto    - [步骤](#步骤-13)auto- [less 17(基于错误的更新查询POST注入)](#less-17基于错误的更新查询post注入)auto    - [原理](#原理-16)auto    - [步骤](#步骤-14)auto- [less 18(基于错误的用户代理，头部POST注入)[存疑]](#less-18基于错误的用户代理头部post注入存疑)auto    - [原理](#原理-17)auto    - [步骤](#步骤-15)auto- [less 19(基于头部的Referer POST报错注入)](#less-19基于头部的referer-post报错注入)auto    - [原理](#原理-18)auto    - [步骤](#步骤-16)auto- [less 20(基于错误的cookie头部POST注入)](#less-20基于错误的cookie头部post注入)auto    - [原理](#原理-19)auto    - [步骤](#步骤-17)auto- [收获](#收获)auto    - [错误信息](#错误信息)auto- [疑问](#疑问)autoauto<!-- /TOC -->
# 引言
